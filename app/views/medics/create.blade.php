...
<div class="panel panel-default">
	<div class="panel-body">
		<div class="page-header">
			<h1><i class="fa fa-user-md fa-2x"></i> Add New Medic </h1>
		</div>
		<form action ="/medics/store" method="get" class="well">
			<div class="form-horizonal">
				...
				<div class = "form-inline">
					...
					<div>
						<input type="text" class = "span 2" placeholder="Employment Type" id="enrotype" name="enrotype" required> </input>
						<input type="date" class = "span 2" placeholder="Employment Date" id="enrodate" name="enrodate" required> </input>
						<small>Avalaibe?</small>
						<label class="radio-inline">
							<input type="radio" id="aval" name="aval" value="1"> Yes
						</label>
						<label class="radio-inline">
							<input type="radio" id="aval" name="aval" value="0"> No
						</label>

						</br>
						<span class="row">
						<label>
							<textarea class="form-control" rows="5" cols="50" id="notes" name="notes">
							</textarea>
						</label>
						</span>
					</div>
